...
if(isset($_POST['submit']))
{
    ...
    $ret="select Email from tbltch where Email=:email";
	...
	if($query -> rowCount() == 0)
	{
		$sql="Insert Into tbltch(FullName,MobileNumber,Email,Password)Values(:fname,:mobno,:email,:password)";
...
<head>
	<meta charset="utf-8">
	<title>Online Quiz | Teacher Signup</title>
