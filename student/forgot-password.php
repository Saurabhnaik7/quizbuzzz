...
if(isset($_POST['reset']))
  {
	...
	$newpassword=md5($_POST['newpassword']);
  	$sql ="SELECT Email FROM tblstd WHERE Email=:email and MobileNumber=:mobno";
	...
	if($query -> rowCount() > 0)
	{
		$con="update tblstd set Password=:newpassword where Email=:email and MobileNumber=:mobno";
